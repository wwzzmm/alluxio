...
public class Input4DoubleV2Test extends Input4BaseV2Test {
  public int unitSize() {
    return Double.BYTES;
  }
  ...
  public void singleReadPos() throws Exception {
    for (int i = 0; i < UNIT_LENGTH; i++) {
      Assert.assertEquals((double) i, (double) mTestStream.readDouble(i * unitSize()), 0);
  ...
  public void randomRead() throws Exception {
    ...
    for (int i = 0; i < time; i++) {
      ...
      Assert.assertEquals((double) p, (double) mTestStream.readDouble(p * unitSize()), 0);
    }
  }
